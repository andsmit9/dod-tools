...
export const STRINGS = {
  ...
  CAPTURE_CONFIG: {
    ...
    GOLDSRC_HOOKS_PLACEHOLDER: 'Optional path to dodtoolsHookGoldSrc.dll (blank = bundled default)',
  ...
  MAIN: {
    ...
    SELECT_GOLDSRC_HOOKS_DLL_TITLE: 'Select GoldSrc Hooks DLL (dodtoolsHookGoldSrc.dll)',
